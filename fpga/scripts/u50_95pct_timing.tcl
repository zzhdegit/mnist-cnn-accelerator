# Full System Timing evaluation for Alveo U50 (95% Accuracy Stable Version)
set part_name "xcu50-fsvh2104-2-e"
create_project -force u50_95pct_timing ./u50_95pct_timing -part $part_name
...
# Run Synthesis (Directed for U50)
...
# Report results
report_timing_summary -file ../../docs/v2_1_timing_summary.txt
report_utilization -file ../../docs/v2_1_utilization_report.txt
